...
// Sub procedures of the game procedure
void boat_placement_procedure(player* player_pointer_list[2], boat* boat_pointer_list[]);
void gameplay_procedure(player* player_pointer_list[2], boat* boat_pointer_list[]);
...
// Boat placement
void place_boat(cell board[ARRAY_SIZE][ARRAY_SIZE], boat* p_current_boat, vector2 cursor_position, int direction);
